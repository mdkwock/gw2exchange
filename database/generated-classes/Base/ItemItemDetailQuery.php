 ...
 *
 * @method     \ItemQuery|\ItemDetailQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ItemItemDetailQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\ItemItemDetailQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'gw2ledger', $modelName = '\\ItemItemDetail', $modelAlias = null)
    {
     ...
     *
     * @param \ItemDetail|ObjectCollection $itemDetail The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($itemDetail instanceof \ItemDetail) {
            return $this
            ...
            throw new PropelException('filterByItemDetail() only accepts arguments of type \ItemDetail or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ItemDetailQuery A secondary query class using the current class as primary query
     */
    public function useItemDetailQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinItemDetail($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ItemDetail', '\ItemDetailQuery');
    }
