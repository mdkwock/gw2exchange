...
/**
 * Base class that represents a row from the 'item_summary' table.
 *
 *
 *
...
abstract class ItemSummary implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ItemSummaryTableMap';
    ...
    /**
     * Initializes internal state of Base\ItemSummary object.
     */
    ...
    /**
     * Compares this with another <code>ItemSummary</code> instance.  If
     * <code>obj</code> is an instance of <code>ItemSummary</code>, delegates to
     * <code>equals(ItemSummary)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ItemSummary The current object, for fluid interface
     */
     ...
     * @return $this|\ItemSummary The current object (for fluent API support)
     */
    ...
    public function setBuyPrice($v)
    {
        ...
        if ($this->buy_price !== $v) {
            $this->buy_price = $v;
            $this->modifiedColumns[ItemSummaryTableMap::COL_BUY_PRICE] = true;
        }
    ...
    public function setSellPrice($v)
    {
        ...
        if ($this->sell_price !== $v) {
            $this->sell_price = $v;
            $this->modifiedColumns[ItemSummaryTableMap::COL_SELL_PRICE] = true;
        }
    ...
    public function setBuyQty($v)
    {
        ...
        if ($this->buy_qty !== $v) {
            $this->buy_qty = $v;
            $this->modifiedColumns[ItemSummaryTableMap::COL_BUY_QTY] = true;
        }
    ...
    public function setSellQty($v)
    {
        ...
        if ($this->sell_qty !== $v) {
            $this->sell_qty = $v;
            $this->modifiedColumns[ItemSummaryTableMap::COL_SELL_QTY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ItemSummaryTableMap::translateFieldName('ItemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ItemSummaryTableMap::translateFieldName('BuyPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buy_price = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ItemSummaryTableMap::translateFieldName('SellPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sell_price = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ItemSummaryTableMap::translateFieldName('BuyQty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buy_qty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ItemSummaryTableMap::translateFieldName('SellQty', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ItemSummary'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildItemSummaryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ItemSummary::setDeleted()
     * @see ItemSummary::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildItemSummaryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ItemSummaryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ItemSummaryTableMap::COL_BUY_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'buy_price';
        }
        if ($this->isColumnModified(ItemSummaryTableMap::COL_SELL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'sell_price';
        }
        if ($this->isColumnModified(ItemSummaryTableMap::COL_BUY_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'buy_qty';
        }
        if ($this->isColumnModified(ItemSummaryTableMap::COL_SELL_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'sell_qty';
        }

        $sql = sprintf(
            'INSERT INTO item_summary (%s) VALUES (%s)',
    ...
    {
        $pos = ItemSummaryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ItemSummary'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ItemSummary'][$this->hashCode()] = true;
        $keys = ItemSummaryTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(ItemSummaryTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ItemSummaryTableMap::COL_ITEM_ID)) {
            $criteria->add(ItemSummaryTableMap::COL_ITEM_ID, $this->item_id);
        }
        if ($this->isColumnModified(ItemSummaryTableMap::COL_BUY_PRICE)) {
            $criteria->add(ItemSummaryTableMap::COL_BUY_PRICE, $this->buy_price);
        }
        if ($this->isColumnModified(ItemSummaryTableMap::COL_SELL_PRICE)) {
            $criteria->add(ItemSummaryTableMap::COL_SELL_PRICE, $this->sell_price);
        }
        if ($this->isColumnModified(ItemSummaryTableMap::COL_BUY_QTY)) {
            $criteria->add(ItemSummaryTableMap::COL_BUY_QTY, $this->buy_qty);
        }
        if ($this->isColumnModified(ItemSummaryTableMap::COL_SELL_QTY)) {
            $criteria->add(ItemSummaryTableMap::COL_SELL_QTY, $this->sell_qty);
        }
    ...
    {
        $criteria = ChildItemSummaryQuery::create();
        $criteria->add(ItemSummaryTableMap::COL_ITEM_ID, $this->item_id);
    ...
    public function hashCode()
    {
        ...
        //relation item_summary_fk_5cf635 to table item
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ItemSummary (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ItemSummary Clone of current object.
     * @throws PropelException
     */
    ...
    public function getItem(ConnectionInterface $con = null)
    {
        if ($this->aItem === null && ($this->item_id !== null)) {
            ...
            $this->aItem->setItemSummary($this);
        }
    ...
    {
        if (null !== $this->aItem) {
            $this->aItem->removeItemSummary($this);
        }
        $this->item_id = null;
        $this->buy_price = null;
    ...
    {
        return (string) $this->exportTo(ItemSummaryTableMap::DEFAULT_STRING_FORMAT);
    }
