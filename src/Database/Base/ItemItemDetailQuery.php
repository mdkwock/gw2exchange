...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    /**
     * Initializes internal state of \GW2Exchange\Database\Base\ItemItemDetailQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'gw2exchange', $modelName = '\\GW2Exchange\\Database\\ItemItemDetail', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \GW2Exchange\Database\ItemDetail object
     *
     * @param \GW2Exchange\Database\ItemDetail|ObjectCollection $itemDetail The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($itemDetail instanceof \GW2Exchange\Database\ItemDetail) {
            return $this
            ...
            throw new PropelException('filterByItemDetail() only accepts arguments of type \GW2Exchange\Database\ItemDetail or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \GW2Exchange\Database\ItemDetailQuery A secondary query class using the current class as primary query
     */
    public function useItemDetailQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinItemDetail($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ItemDetail', '\GW2Exchange\Database\ItemDetailQuery');
    }
    ...
    public function doSelect(ConnectionInterface $con = null)
    {
        ...
        $db = Propel::getServiceContainer()->getAdapter(ItemItemDetailTableMap::DATABASE_NAME);
