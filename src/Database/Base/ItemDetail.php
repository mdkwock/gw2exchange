...
abstract class ItemDetail implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\GW2Exchange\\Database\\Map\\ItemDetailTableMap';
    ...
    /**
     * Initializes internal state of GW2Exchange\Database\Base\ItemDetail object.
     */
     ...
     * @return $this|\GW2Exchange\Database\ItemDetail The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\GW2Exchange\\Database\\ItemDetail'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\GW2Exchange\Database\ItemDetail
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\GW2Exchange\Database\ItemDetail The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GW2Exchange\Database\ItemDetail (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \GW2Exchange\Database\ItemDetail Clone of current object.
     * @throws PropelException
     */
    ...
    public function initItems()
    {
        ...
        $this->collItems->setModel('\GW2Exchange\Database\Item');
    }
