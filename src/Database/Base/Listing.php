...
abstract class Listing implements ActiveRecordInterface
{
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[ListingTableMap::COL_TYPE] = true;
        }
    ...
    public function setOrders($v)
    {
        ...
        if ($this->orders !== $v) {
            $this->orders = $v;
            $this->modifiedColumns[ListingTableMap::COL_ORDERS] = true;
        }
    ...
    public function setUnitPrice($v)
    {
        ...
        if ($this->unit_price !== $v) {
            $this->unit_price = $v;
            $this->modifiedColumns[ListingTableMap::COL_UNIT_PRICE] = true;
        }
    ...
    public function setQuantity($v)
    {
        ...
        if ($this->quantity !== $v) {
            $this->quantity = $v;
            $this->modifiedColumns[ListingTableMap::COL_QUANTITY] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ListingTableMap::COL_ORDERS)) {
            $modifiedColumns[':p' . $index++]  = 'orders';
        }
        if ($this->isColumnModified(ListingTableMap::COL_UNIT_PRICE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ListingTableMap::COL_ORDERS)) {
            $criteria->add(ListingTableMap::COL_ORDERS, $this->orders);
        }
        if ($this->isColumnModified(ListingTableMap::COL_UNIT_PRICE)) {
            $criteria->add(ListingTableMap::COL_UNIT_PRICE, $this->unit_price);
        }
        if ($this->isColumnModified(ListingTableMap::COL_QUANTITY)) {
